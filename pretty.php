  ...
  */
  ...
  if (filter_has_var(INPUT_POST, 'desc')) {
    ...
    if ($orig_desc) {
      ...
      define('SECTION_START', '<div class="card mb-3 border-secondary"><div class="card-header bg-secondary text-light"><h2 class="card-title mb-0">');
      define('HEAD_END_UL_START', '</h2></div><ul class="list-group list-group-flush">');
      define('LI_START', '<li class="list-group-item d-flex ps-0"><a href="#" class="bi-bookmark-heart" onclick="toggleHighlight()" role="button" aria-label="Highlight item"></a><span>');
      define('LI_END', '</span></li>');
      define('SECTION_END', '</ul></div>');
...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="bootstrap/bootswatch-sandstone.css">
